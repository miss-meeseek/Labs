...
//javadoc MyPaint.java 

/**
*MyPaint program to applet do rysowania figur. Pozwala na zmiane ich rozmiaru oraz miejsca i koloru.  
*@author Volha Hutouskaya
*/ 
public class MyPaint extends JApplet implements ActionListener {
	/** 
	* MenuBar appleta
	*/
	private MenuBar myMenu;
	/** 
	* Menu i Podmenu appleta 
	*/
	private Menu menu1, submenu;
	/** 
	* Opcje do wybrania w meniu
	*/
	private MenuItem i0, i1, i2, i3, i4;
	/** 
	* Okno dialogowe, zawiera informacje o programie 
	*/
	private JDialog myDialog;
	/** 
	* Zmienna odpowiadajaca opcji wybranej w meniu 
	*/
	int action = 0;
    /** 
	* Tworzy {@link MyPaint} 
	*/
    public void init() {
		...
		i1 = new MenuItem("Circle");
		i1.addActionListener(this);
		i2 = new MenuItem("Rectangle");
		i2.addActionListener(this);
		i4 = new MenuItem("Polygon");
		i4.addActionListener(this);
		i0 = new MenuItem("Empty");
		i0.addActionListener(this);
		i3 = new MenuItem("Info");
		...
		((Frame)c).setMenuBar(myMenu); 
		add(new MyPanel());
		((Frame)c).addWindowListener(new menuAppletWindowAdapter());
	}
	/** 
	* Metoda do obslugi menu. Po wybraniu jednej z opcji w meniu zapisuje ja do zmiennej action {@link action}
	*/
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Info")){
				myDialog = new Dialog();
				myDialog.setBounds(240, 180, 440, 400);
	...
	* @author Volha Hutouskaya
	*/
	class MyPanel extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener {
		/**
